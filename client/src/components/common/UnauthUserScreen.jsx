...
const UnauthUserScreen = () => {
  ...
  <div className='container mx-auto px-4'>
    <div className='text-center mb-12'>
      <h2 className='text-3xl font-bold text-slate-200 mb-4'>Who we are?</h2>
 ...
 <section id="joinUs" className="py-20 text-slate-200">
      <div className="container mx-auto px-4">
        ...
        <div className="w-full max-w-sm mx-auto mb-12">
          <div className="bg-gray-700/50 h-2 rounded-full overflow-hidden">
            <div 
              className="bg-gradient-to-r from-yellow-400 to-yellow-600 h-full transition-all duration-1000 ease-out"
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className={`bg-gradient-to-br from-[#1a1a2e] via-[#1a1a2e] to-[#111111] p-6 rounded-xl transition-all duration-300 ${
                ...
                {step.button && (
                  <button className={`bg-yellow-500 text-black px-6 py-2 rounded-full font-bold transition-all duration-300 ${
                    isStepVisible(index) ? 'hover:bg-yellow-600 hover:scale-105' : 'opacity-50'
                  }`}>
                    {step.button}
                  </button>
                )}
        ...
        >
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-0.5 bg-gray-600/30">
            <div 
              className="bg-gradient-to-b from-yellow-500 to-yellow-400 w-full transition-all duration-1000 ease-out"
              ...
              >
                ...
                <div
                  className={`absolute left-1/2 transform -translate-x-1/2 w-6 h-6 rounded-full border-4 border-[#1a1a2e] z-10 transition-all duration-500 ${
                    isStepCurrent(index) 
                      ? 'bg-yellow-500 scale-125 animate-pulse shadow-lg shadow-yellow-500/50' 
                      : isStepVisible(index) 
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="text-center mt-16">
      <button className="bg-[#CBA135] hover:bg-yellow-600 text-black font-bold 
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-[#1a1a2e] via-[#1a1a2e] to-[#111111] p-8 rounded-xl 
        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg bg-[#0d0d0d] border border-[#CBA135]/20 
                focus:border-[#CBA135] focus:ring-2 focus:ring-[#CBA135]/20 
          ...
          <button
            type="submit"
            className="w-full bg-[#CBA135] hover:bg-yellow-600 text-black font-bold 
              py-3 px-8 rounded-full transition-all duration-300 
              transform hover:scale-105 
              shadow-[0_4px_20px_rgba(203,161,53,0.4)] 
              hover:shadow-[0_6px_30px_rgba(203,161,53,0.6)]"
      ...
      <div className="space-y-8">
        <div className="bg-gradient-to-br from-[#1a1a2e] via-[#1a1a2e] to-[#111111] p-8 rounded-xl 
          shadow-[0_4px_20px_rgba(203,161,53,0.2)] hover:shadow-[0_6px_30px_rgba(203,161,53,0.4)] 
          transition-all duration-500">
          <h3 className="text-xl font-bold text-[#CBA135] mb-4">Contact Information</h3>
          <div className="space-y-4">
            <div className="flex items-center space-x-4 text-slate-300">
              <svg className="w-5 h-5 text-[#CBA135]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-gradient-to-br from-[#1a1a2e] via-[#1a1a2e] to-[#111111] p-8 rounded-xl 
          shadow-[0_4px_20px_rgba(203,161,53,0.2)] hover:shadow-[0_6px_30px_rgba(203,161,53,0.4)] 
          transition-all duration-500">
          <h3 className="text-xl font-bold text-[#CBA135] mb-4">Follow Us</h3>
          <div className="flex space-x-4">
            ...
            <a href="#" className="p-2 rounded-full border border-[#CBA135]/20 hover:border-[#CBA135] 
              ...
              <svg className="w-6 h-6 text-[#CBA135]" fill="currentColor" viewBox="0 0 24 24">
